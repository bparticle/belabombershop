  ...
  try {
    switch (eventName) {
      case "order.completed":
        ...
        const orderData = {
          invoiceNumber: String(content.invoiceNumber || req.body.invoiceNumber || ''),
          email: String(content.email || req.body.email || ''),
    ...
    console.error('Webhook v1 processing error:', err);
